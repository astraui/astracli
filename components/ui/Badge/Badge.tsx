...
const badgeVariants = cva("rounded-md font-semibold transition duration-200", {
  variants: {
    variant: {
      primary:
        "bg-black text-white dark:bg-white dark:text-black hover:opacity-75",
      secondary:
        "bg-neutral-200 text-neutral-700 dark:bg-neutral-600 dark:text-neutral-200 hover:opacity-75",
      outline:
        "bg-transparent text-black dark:text-white border border-neutral-200 dark:border-neutral-800 hover:opacity-75",
      ghost:
